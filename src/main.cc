...
#define GENERATE_CAR_NIGHT      1.595       // 22:00 -  6:00
...
double gDayCoefficient = 0;         // multiplier of car generator
int gDay = 0;                       // Day in week
int gTime = 0;                      // Time of result
...
class Car : public Process
{
    ...
    void Behavior()
    {
        ...
        // We process information only for specific time. (for example 6:00 - 18:00 etc.)
        ...
        do
        {
            ...
            // Get current speed depending on number of cars in a specific part of the highway.
