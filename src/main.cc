...
class GeneratorProgress : public Event
{
	void Behavior()
	{
		std::cout << "Progress: " << Time / 3600 << " / 24" << std::endl;
...
int main()
{
	...
	_Print("Na km   1 -   2 projelo %d aut. Mělo by projet 44 230\n", gCounterKm1to2);
	_Print("Na km   2 -   6 projelo %d aut. Mělo by projet 37 180\n", gCounterKm2to6);
	_Print("Na km  12 -  15 projelo %d aut. Mělo by projet 36 698\n", gCounterKm12to15);
	_Print("Na km  41 -  49 projelo %d aut. Mělo by projet 18 527\n", gCounterKm41to49);
	_Print("Na km 153 - 162 projelo %d aut. Mělo by projet 17 678\n", gCounterKm153to162);
	_Print("Na km 194 - 196 projelo %d aut. Mělo by projet 32 508\n\n", gCounterKm194to196);
